...
export default function MaterialCategoryCreate() {
    ...
    function submit(e) {
        e.preventDefault();
        post("/master/material-categories");
    }
        ...
        <AppLayout>
            <div className="max-w-3xl mx-auto">
                <div className="bg-gradient-to-r from-slate-800 to-slate-900 text-white rounded-xl p-6 mb-6">
                    <h1 className="text-xl font-semibold">Tambah Kategori Material Baru</h1>
                    <p className="text-slate-300 mt-1">Silakan isi informasi kategori material dengan lengkap</p>
                </div>
