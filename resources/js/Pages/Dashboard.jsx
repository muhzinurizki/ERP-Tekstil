  ...
  return (
    <AppLayout>
      <div className="space-y-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div>
              ...
              <p className="mt-3 text-gray-600 max-w-2xl">
                Anda masuk sebagai <span className="font-medium">{role}</span>.
        ...
        ">
          <p className="text-sm text-gray-500">
            Modul dashboard lanjutan (KPI, grafik, approval list)
            akan ditampilkan di sini setelah data tersedia.
          </p>
        </section>
      </div>
    </AppLayout>
